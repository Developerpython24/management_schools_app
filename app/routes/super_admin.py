...
class SchoolForm(FlaskForm):
    ...
    address = StringField('آدرس', validators=[Length(max=200)])
    phone = StringField('شماره تماس', validators=[Length(max=20)])
    email = StringField('ایمیل', validators=[Email(message='ایمیل معتبر نیست'), Length(max=100)])
